...
class Connection {
    ...
    spawnProcesses() {
        ...
        this.processes.color = require('./ffmpegInterface').ffmpeg_image2mp4(colorOutputPath, constants.RECORDING_FPS, 'mjpeg', constants.COLOR_WIDTH, constants.COLOR_HEIGHT, constants.COLOR_CRF, constants.COLOR_SCALE);
        ...
        this.processes.depth = require('./ffmpegInterface').ffmpeg_image2mp4(depthOutputPath, constants.RECORDING_FPS, 'png', constants.DEPTH_WIDTH, constants.DEPTH_HEIGHT, constants.DEPTH_CRF, constants.DEPTH_SCALE);
